    ...
    return(
        <div className="lg:px-14 sm:px-8 px-4 py-10">
            ...
            <div class="grid md:grid-cols-5 grid-cols-4 gap-4 pb-2 font-semibold items-center ">
                <div className="md:col-span-2 justify-self-start text-lg text-slate-800 lg:ps-4">Products</div>
                ...
                <div className="flex text-sm gap-1 flex-col">
                    <div className="flex justify-between w-full md:text-lg text-sm font-semibold">
                        ...
                        <Link className="w-full flex justify-end" to={"/checkout"}>
                            <button className="font-semibold w-[300px] py-2 px-4 rounded-sm bg-blue-600 text-white flex items-center justify-center gap-2 hover:text-gray-300 transition duration-500">
