        ...
        <div className="max-w-7xl mx-auto px-4 p-8">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center mb-12">
                <div className="w-full md:w-1/2 text-center md:text-left">
                    <p className="text-lg mb-4">Welcome to our E-commerce store! we are dedicated for providing the best products and services to the customers. Our mission is to offer a seemless shopping experience while ensuring the height quality of our offerings</p>
                </div>
                <div className="w-full md:w-1/2 mb-6 md:mb-0">
                    <img src="https://embarkx.com/sample/placeholder.png" alt="About Us" className="w-full h-auto rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105"></img>
                </div>
            </div>
